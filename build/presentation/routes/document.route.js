...
documentRouter.get("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, documentController.getDocumentById);
documentRouter.post("", documentController.createDocument);
documentRouter.patch("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, documentController.updateDocument);
