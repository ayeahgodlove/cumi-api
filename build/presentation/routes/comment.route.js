...
commentRouter.get("/:postId", is_authenticated_middleware_1.isAuthenticatedMiddleware, commentController.getPostComments);
...
commentRouter.patch("/:id", is_authenticated_middleware_1.isAuthenticatedMiddleware, commentController.updateComment);
